...
from model_to_view.eq_mt_sub_task.serializer import EMSTListSerializer
...
class FlowServiceEMST(FlowBaseService):
    """维保子任务"""
    model = EquipmentMaintenanceSubTask
    form_serialize = EMSTListSerializer
    serial_number = 'serial_number'
    form_name = '维保-维保子任务总结审批'
