...
from model_to_view.check_route.serializer import CheckRouteListSerialize
from models import FlowStatus, IsValid
from utils.flow_base_service import FlowBaseService
from models.check.check_route import CheckRoute


class FlowServiceCheckRoute(FlowBaseService):
    model = CheckRoute
    form_serialize = CheckRouteListSerialize
