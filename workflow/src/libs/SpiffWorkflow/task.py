...
class Task(object):
    ...
    COMPLETED 0b100000
    CANCELLED 0b1000000
    0b1100000 FINISHED_MASK = CANCELLED | COMPLETED  = 96
    0b1111100 DEFINITE_MASK = FUTURE | WAITING | READY | FINISHED_MASK = 124
    0b111 PREDICTED_MASK = FUTURE | LIKELY | MAYBE  = 7
    0b11111 NOT_FINISHED_MASK = PREDICTED_MASK | WAITING | READY  = 31
    0b1111111 ANY_MASK = FINISHED_MASK | NOT_FINISHED_MASK  = 127
    """
